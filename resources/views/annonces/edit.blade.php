            ...
            <div class="panel-col">
                ...
                <form action="{{ route('annonces.update',$annonce->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$annonce->titre}}" type="text" name="titre" class="form-control" required>
                    </div>
                   
                    <div class="form-group">
                        <label for="description">Description:</label>
                        <textarea value="{{$annonce->description}}" name="description" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="prix">Prix:</label>
                        <input type="text" value="{{$annonce->prix}}" name="prix" class="form-control" required>
                    </div>
                    <div class="form-group">
